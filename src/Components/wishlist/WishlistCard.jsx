    ...
    <>
        <div className='w-72 h-96 relative ring-1 ring-slate-400 relative'>
            ...
            <div className='flex flex-col justify-between items-center '>
                ...
                <button className='ring-1 ring-fuchsia-600 bg-slate-50 w-72 h-10 text-fuchsia-600 font-semibold cursor-pointer active:bg-slate-300'  onClick={handleCart}  >ADD TO BAG</button>
            </div>
        </div>
    </>
  )
